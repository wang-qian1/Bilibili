...
<script src="<%=request.getContextPath()%>/static/adminjs/liebiao.js">
</script>
...
#search_box #go {
	...
	<div id="menu1" class="menu">
		<ul>
			...
			<li><a href="details.sf">动 画</a></li>
			<li><a href="details.sf">番 剧</a></li>
			<li><a href="details.sf">国 创</a></li>
			<li><a href="details.sf">音 乐</a></li>
